...
export const responseMessages: { [key: number]: MessageData; } = {
    ...
    1053: { message: 'This mobile number is already in use', status: MessageStatus.failure },
    1054: { message: 'User registered successfully', status: MessageStatus.success },
    1055: { message: 'User not found', status: MessageStatus.failure },
